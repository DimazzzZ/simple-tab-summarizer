...
• **Tab Group Summarization** — Select and summarize all tabs in a group at once
...
4. **Choose your language** and click "Summarize Selected"
5. **Review the summary** — copy it to clipboard with one click
