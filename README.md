...
<p align="center">
  ...
  <a href="manifest.json">
    <img src="https://img.shields.io/badge/Version-1.2.0-lightgrey" alt="Version 1.2.0" />
  </a>
  <a href="tests/">
...
- 🛑 **Stop Summarization** — Cancel ongoing summarization requests mid-flight
- 🌍 **Unicode-Safe Extraction** — Properly handles Cyrillic, CJK, and all non-Latin text
...
├── lifecycle/               # Browser event listeners
├── render/                  # UI rendering components (lists, overlays, feedback)
├── sync/                    # Storage synchronization logic
├── utils/                   # General utilities (logger, debounce, chrome-helpers)
├── icons/
...
- `popup.js` and `sidebar.js` are thin entrypoints that create a controller instance with DOM references and mode-toggle
  behavior
